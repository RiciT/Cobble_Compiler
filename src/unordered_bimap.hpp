...
template<
    class _KeyType,
    class _ValueType,
    class _Key_Container = std::unordered_set<_KeyType>,
    class _Mapped_Container = std::unordered_set<_ValueType>>
...
public:
    ...
    unordered_bimap(std::initializer_list<_Tree_Node> init)
    {
